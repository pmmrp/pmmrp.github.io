...
Many of the NHS integrative healthcare pilots address conditions with limited treatment options for example palliative care in cancer, or musculoskeletal and chronic pain conditions, with and without concurrent mental health issues (ref 9999). This limitation coupled with late-stage application are major drawbacks with profound implications for research on efficacy of the multi-modality approach outwith the chronic conditions population. 
